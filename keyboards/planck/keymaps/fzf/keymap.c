...
[_LOWER] = LAYOUT_planck_grid(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_SLSH, KC_EQL,  KC_BSLS,
    KC_DEL,  _______, _______, _______, _______, _______, _______, KC_LBRC, KC_LCBR, KC_RCBR, KC_RBRC, KC_UNDS,
...
[_RAISE] = LAYOUT_planck_grid(
    KC_GRV,  _______, KC_1,    KC_2,    KC_3,    _______, _______, _______, _______, KC_QUES, KC_PLUS, KC_PIPE,
    KC_DEL,  _______, KC_4,    KC_5,    KC_6,    _______, _______, _______, _______, KC_LPRN, KC_RPRN, KC_MINS,
